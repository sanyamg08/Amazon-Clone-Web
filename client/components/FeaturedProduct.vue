      ...
      <div class="row">
        <div class="col-sm-5 text-center">
          <div class="bx-root-image">
            <img src="/img/leo.jpg" class="img-fluid" />
          </div>
        </div>
        <div class="col-sm-7 m-auto">
          <div class="bx-root-dtls">
            <div class="bx-root-heading">Da Vinci</div>
          </div>
          <div class="bx-root-subtext">Inside the Mind of the legendary Leanardo Da Vinci</div>
